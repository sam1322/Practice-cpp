...
int countScc(vector<vector<int>> &adj,int n ){
    ...
    // then repeat dfs and find the scc and pop the stack 
    // as you execute dfs for each and every node in the stack
    ...
    cout<<"Total there are "<<sum<<" strongly connected components\n "; 
    return sum ; 
}
