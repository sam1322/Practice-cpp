...
int largestBST(Node* root,bool &isbst,int &Min ,int &Max , int &ans) ;
...
int largestBst(Node *root)
{
    ...
    bool isbst = true  ; 
     ...
     largestBST(root,isbst,Min,Max,ans);
    return ans ; 
}
int largestBST(Node* root,bool &isbst,int &Min ,int &Max , int &ans) {
    if(!root){
    ...
    Max = INT_MIN ; 
    int lsize = largestBST(root->left,isbst,Min,Max , ans);
    ...
    Min = INT_MAX ; 
    int rsize = largestBST(root->right ,isbst , Min , Max ,ans ); 
